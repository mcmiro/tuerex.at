      ...
      <UI.Container>
        ...
        <div className="mt-[56px]">
          ...
          >
            ...
            Gegebenheiten (z. B. die Art der Tür, etc.) und stellt sicher, dass
            wir alle relevanten Informationen haben.
          </UI.Typography>
        </div>
        <div className="mt-[56px]">
          <UI.Typography
        ...
        <div className="mt-[56px]">
          ...
          >
            ...
            voraussichtliche Wartezeit mit. Im Normalfall sind wir innerhalb von
      ...
      <UI.Container>
        <div className="mt-[56px]">
          ...
          <UI.Typography
            ...
            className="mt-6 !text-[18px] text-primary-900 leading-8"
          >
            Sobald wir eintreffen, starten wir ohne zusätzliches Warten mit der
            Türöffnung.
          </UI.Typography>
        </div>
        <div className="mt-[56px]">
          ...
          <UI.Typography
            ...
            className="mt-6 !text-[18px] text-primary-900 leading-8"
          >
            Ob zugeschlagene Tür oder eine verschlossene Sicherheitstür, unsere
            Profis haben die passende Lösung für eine schnelle und
