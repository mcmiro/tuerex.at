        ...
        <UI.Container>
          ...
          <div className="mt-[56px]">
            ...
            >
              ...
              erforderlichen Lizenzen und Qualifikationen. Der AN ist jedoch
              nicht verpflichtet, diese zu kontrollieren. Sollten Sie
              Unstimmigkeiten bemerken, bitten wir Sie, dies umgehend unter
              info@tuerex.at zu melden.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            <UI.Typography
            ...
            >
              ...
              Einhaltung der gesetzlichen Vorschriften im Bereich
              Schlüsseldienst.
              <br></br>
              <br></br>
          ...
          <div className="mt-[56px]">
            ...
            >
              ...
              ändern sich nicht, es sei denn, es kommt zum Mehraufwant für den
              AN, oder die Angaben des AN stimmen bei der Ankunft nicht.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            <UI.Typography
            ...
            >
              ...
              eine Rechnung per E-Mail oder Post zugeschickt. Diese beinhaltet
              den Bruttopreis der Dienstleistung, mit einem Zahlungsziel von 5
              Werktagen (ohne Abzug oder Skonto). <br></br>
              <br></br>
              Sollte die Zahlung innerhalb dieser Frist nicht erfolgen, behalten
              wir uns vor, die offene Forderung an ein Inkassobüro
              weiterzuleiten.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            ...
            <UI.Typography
              ...
              className="mt-6 !text-[18px] text-primary-900 leading-8"
            >
              Der AG ist verpflichtet, die bestellte Dienstleistung in Anspruch
              zu nehmen. Falls dies seitens AG ohne vorherige Stornierung
              ignoriert wird, ist die volle Summe der Dienstleistung zu
              bezahlen.
              <br></br>
              <br></br>
              ...
              <br></br>
              <br></br>
              Pünktliches Erscheinen zur vereinbarten Uhrzeit gehört ebenfalls
              zur Pflicht des AG.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            ...
            >
              ...
              werden. Bei Stornierung fällt eine Pauschal-Stornogebühr in Höhe
              von € 50 an.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            ...
            <UI.Typography
              ...
              className="mt-6 !text-[18px] text-primary-900 leading-8"
            >
              Falls seitens AG mehrfache Buchungen (bei AN und einem oder
              mehreren Anbietern) für dieselbe Dienstleistung getätigt wurden,
              ist der AG verpflichtet, die bestellte Dienstleistung zu
              konsumieren und die übrigen zu stornieren.
              <br></br>
              <br></br>
              ...
              <br></br>
              <br></br>
              Sollte kein Storno seitens AG erfolgen, sehen wir uns gezwungen,
              die Dienstleistung in voller Summe zu verrechnen, auch wenn diese
          ...
          <div className="mt-[56px]">
            ...
            >
              ...
              <br></br>
              <br></br>
              Falls solche Vereinbarungen dennoch stattfinden, übernimmt AN
              keine Haftung für weitere Ereignisse.
              <br></br>
              <br></br>
