...
const IndexPage: React.FC<{ data: DistrictItem[] }> = ({ data }) => {
  return (
    <Layout
      canonical={`https://tuerex.at/leistungen`}
    ...
    >
      <header className="mb-16">
        ...
        <UI.HeaderSub title="Geschäftskunden" />
        <UI.Breadcrumbs />
      </header>
        ...
        <UI.Container>
          <div className="mt-[56px]">
            ...
            >
              ...
              sind darauf ausgerichtet, dir nicht nur bei Türöffnungen zu
              helfen, sondern umfassen alle Schlosserarbeiten, um deine
          ...
          <div className="mt-[56px]">
            ...
            >
              ...
              Türöffnungen, sondern kümmern sich auch um individuelle
              Reparaturen nach deinen Bedürfnissen.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            <UI.Icon icon={CheckBadgeIcon} />
            ...
            >
              ...
              Schlüsselnotdienst hinaus. Wir setzen auf modernste Technologien
              und bewährte Methoden, um deine Sicherheit zu maximieren. Von
              ...
              Vertraue auf unsere Erfahrung und Hingabe, um die Sicherheit
              deines Zuhauses oder Unternehmens auf das nächste Level zu heben.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            <UI.Icon icon={CheckBadgeIcon} />
            ...
            >
              ...
              Handhabung. Mit modernster Technologie und hochwertigen
              Materialien gewährleisten wir maximale Sicherheit für dein Zuhause
              oder Unternehmen.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            ...
            <UI.Typography
              ...
              className="mt-6 !text-[18px] text-primary-900 leading-8"
            >
              Vertraue auf unsere Experten für die professionelle Installation
              und Wartung hochwertiger Schlösser. Unsere Schlossanlagen zeichnen
              sich durch Robustheit und Präzision aus, um einen zuverlässigen
              Schutz vor unbefugtem Zugang zu gewährleisten.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            <UI.Icon icon={CheckBadgeIcon} />
            ...
            >
              ...
              intelligenten Schließanlagen bieten genau das. Sie ermöglichen
              eine flexible und sichere Verwaltung von Berechtigungen, um den
          ...
          <div className="mt-[56px]">
            ...
            >
              ...
              ästhetische Ergänzung zu deinen Türen, sondern auch eine
              zusätzliche Schutzschicht. Hergestellt aus robusten Materialien,
              tragen sie dazu bei, potenzielle Schwachstellen zu stärken und die
              Sicherheit deines Zuhauses zu erhöhen.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            <UI.Icon icon={CheckBadgeIcon} />
            ...
            <UI.Typography
              ...
              className="mt-6 !text-[18px] text-primary-900 leading-8"
            >
              Unsere umfassenden Sicherheitsmaßnahmen für Türen beruhen auf
              einer Kombination aus modernster Sicherheitstechnologie und
              bewährten Schutzvorrichtungen. Wir bieten individuelle Lösungen,
              die auf deine spezifischen Anforderungen zugeschnitten sind, um
              ein Höchstmaß an Sicherheit zu gewährleisten.
            </UI.Typography>
          </div>
          <div className="mt-[56px]">
            <UI.Icon icon={CheckBadgeIcon} />
          ...
          <div className="my-[56px]">
            ...
            >
              ...
              individuelle Reparaturen, die sich nach deinen Wünschen richten.
              Wir passen Schließsysteme und Sicherheitsvorkehrungen speziell an
              deine Bedürfnisse an, um eine maßgeschneiderte Sicherheitslösung
              zu gewährleisten.
            </UI.Typography>
          </div>
        </UI.Container>
