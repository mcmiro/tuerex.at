...
const classesSchema = {
  ...
  variant: {
    ...
    h1: 'text-h1 tracking-tighter',
    h2: 'text-h2 tracking-tighter',
    h3: 'text-h3 tracking-tighter',
    h4: 'text-h4 tracking-tighter',
    h5: 'text-h5 tracking-tighter',
    h6: 'text-h6 tracking-tighter',
  },
  align: {
    left: 'text-left',
    center: 'text-center',
